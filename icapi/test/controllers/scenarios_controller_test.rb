...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference('Scenario.count') do
      post scenarios_url, params: { scenario: { description: @scenario.description, game_id: @scenario.game_id, title: @scenario.title } }, as: :json
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { description: @scenario.description, game_id: @scenario.game_id, title: @scenario.title } }, as: :json
    assert_response 200
  end
